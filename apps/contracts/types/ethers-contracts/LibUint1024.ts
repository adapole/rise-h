...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "./common.js"
  ...
  export interface LibUint1024Interface extends Interface {
  ...
  export interface LibUint1024 extends BaseContract {
    
    connect(runner?: ContractRunner | null): LibUint1024;
    waitForDeployment(): Promise<this>;

    interface: LibUint1024Interface;
