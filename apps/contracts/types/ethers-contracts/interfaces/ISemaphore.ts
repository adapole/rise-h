...
export declare namespace ISemaphore {
  ...
  export interface ISemaphoreInterface extends Interface {
    getFunction(nameOrSignature: "acceptGroupAdmin" | "addMember" | "addMembers" | "createGroup(address,uint256)" | "createGroup()" | "createGroup(address)" | "groupCounter" | "removeMember" | "updateGroupAdmin" | "updateGroupMerkleTreeDuration" | "updateMember" | "validateProof" | "verifyProof"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "GroupMerkleTreeDurationUpdated" | "ProofValidated"): EventFragment;
...
decodeFunctionResult(functionFragment: 'verifyProof', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    updateMember: TypedContractMethod<
      [groupId: BigNumberish, oldIdentityCommitment: BigNumberish, newIdentityCommitment: BigNumberish, merkleProofSiblings: BigNumberish[], ],
      [void],
      'nonpayable'
    >
