...
async function main() {
    ...
    console.log(`Calling createNFTCollection() with ${HBAR_TO_SEND} HBAR to create the HTS collection...`)
    ...
    console.log("Underlying HTS NFT Collection (ERC721 facade) address:", tokenAddress)
}
