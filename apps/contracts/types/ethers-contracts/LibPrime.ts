...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "./common.js"
  ...
  export interface LibPrimeInterface extends Interface {
  ...
  export interface LibPrime extends BaseContract {
    
    connect(runner?: ContractRunner | null): LibPrime;
    waitForDeployment(): Promise<this>;

    interface: LibPrimeInterface;
